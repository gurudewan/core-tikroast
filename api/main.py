import logging
from api.fastAPI_config import app # the fastAPI app

import api.analyser as analyser
#import api.scrapers.apify_scraper as scraper

import api.scraping.apify.tiktok as tiktok_scraper

import api.eyes.blip_see as see

from pprint import pprint

import api.scraping.schema_mapper as schema_mapper

import api.eyes.processor as processor

from api.database.databaser import db
